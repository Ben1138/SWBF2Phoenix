...
public struct PhxTransform
{
    ...
    public static PhxTransform None => new PhxTransform { Position = Vector3.zero, Rotation = Quaternion.identity };
}
...
public class PhxScene
{
    ...
    public PhxScene(PhxEnvironment env, Container c)
    {
        ENV = env;
        EnvCon = c;
        Cra = Cra = new CraMain(new CraSettings
        {
            Players        = new CraBufferSettings { Capacity = 200000, GrowFactor = 1.5f },
            Clips          = new CraBufferSettings { Capacity = 1000,   GrowFactor = 1.5f },
            ClipTransforms = new CraBufferSettings { Capacity = 300000, GrowFactor = 1.5f },
            Bones          = new CraBufferSettings { Capacity = 30000,  GrowFactor = 1.5f },
            MaxBones       = 30000,
